...
void LCD_voidInit()
{
	...
	delay_ms(100);
	LCD_voidSendInstrution(0b00111100);
	delay_ms(2);
	LCD_voidSendInstrution(0b00111100);
	delay_ms(2);
	//0b00001DCB, D:SetDisplay, C: cursor, B: Blinking Cursor
	LCD_voidSendInstrution(0b00001111);
	delay_ms(2);
	LCD_voidSendInstrution(LCD_u8_ClearDisplay);
	delay_ms(2);
	LCD_voidSendInstrution(0b00000110);
...
{
	LCD_voidSendInstrution(0x80 + 0x40*y + x);
}
...
{
	LCD_voidSendInstrution(0b00011100);
}


void LCD_voidShiftLeftDisplay()
{
	LCD_voidSendInstrution(0b00011000);
}
